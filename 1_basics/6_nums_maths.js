...
console.log(num.toFixed(2));  // with the help of toFixrd() method its allow the Number of digits after the decimal point. Ex -> output is 12.55
...
console.log(hundreds.toLocaleString());  // if we only call toLocaleString() method value we provide US standards values.

console.log(hundreds.toLocaleString('en-IN'));  // if we call toLocaleString('en-IN) method value we provide indian standards values.
...
console.log(Math);
console.log(Math.abs(-5));  // this method Maths.abs() method we provide positive number. 
// Return -> 4

console.log(Math.round(4.6));  // this method round the number of nearest integer.
...
console.log(Maths.ceil(4.2));  // this methode is used to round a number up the next largest intiger, even if the number is already an integer.
// this method is useful when you always want to round a number upwards.

console.log(Math.floor(4.9));  // this method is useful when you always want to round a number downwards. // Return -> 4
